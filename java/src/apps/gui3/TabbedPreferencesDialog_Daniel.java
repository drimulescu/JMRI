 ...
 */
public final class TabbedPreferencesDialog_Daniel extends JDialog implements WindowListener {
    ...
    public static boolean showDialog(TabbedPreferences.FilterPreferences filterPreferences, boolean addQuitButton) {
        try {
            ...
            TabbedPreferencesDialog_Daniel dialog = new TabbedPreferencesDialog_Daniel();
...
//            if (preferencesItem != null) f.gotoPreferenceItem(preferencesItem, preferenceSubCat);
    ...
    public TabbedPreferencesDialog_Daniel() {
        super();
        setModal(true);
//        TabbedPreferences tabbedPreferences = getTabbedPreferences();
//        TabbedPreferences tabbedPreferences = getTabbedPreferences();
        TabbedPreferences_Daniel tabbedPreferences = getTabbedPreferences();
        tabbedPreferences.dialog = this;
        tabbedPreferences.init(true);
...
*/    
    TabbedPreferences_Daniel tabbedPreferences_Daniel = new TabbedPreferences_Daniel();
    private TabbedPreferences_Daniel getTabbedPreferences() {
        return tabbedPreferences_Daniel;
    }
